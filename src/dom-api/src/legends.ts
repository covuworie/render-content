...
const maradona = new Legend("Diego Maradona", "Argentina", "Attacking midfielder");
const beckenbauer = new Legend("Franz Beckenbauer", "Germany", "Libero");
const yashin = new Legend("Lev Yashin", "Goalkeeper", "Soviet Union");
const charlton = new Legend("Bobby Charlton", "Attacking midfielder", "England");
...
const rijkaard = new Legend("Frank Rijkaard", "Netherlands", "Defensive Midfielder");
const matthaeus = new Legend("Lothar Matthaeus", "Germany", "Box-to-box midfielder");
...
const messi = new Legend("Messi", "Argentina", "Forward");
...
export let Legends = [
    pele, maradona, beckenbauer, yashin, charlton, eusebio, zidane, ronaldo, cruyff,
    moore, best, garrincha, rijkaard, matthaeus, carlos, cafu, banks, messi, cristiano,
    muller, baresi, maldini
];
